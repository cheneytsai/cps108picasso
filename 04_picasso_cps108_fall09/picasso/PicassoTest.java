...
public class PicassoTest extends TestCase
{
            ...
            throws FileNotFoundException
    {
        ...
        testResults = new Scanner(new File("testdata\\" + fileName
                + "_results.in"));
    }
    ...
    public void testImageHandler() throws FileNotFoundException
    {
        ...
        {
            assertEquals(ImageHandler.addImage(testInput.nextLine()),
                    testResults.nextLine());
        }
    }
    ...
    public void testPreProcess() throws FileNotFoundException
    {
        ...
        while (testInput.hasNext())
        {
            assertEquals(parse.preProcess(testInput.nextLine()), testResults
                    .nextLine());
        }
    }
