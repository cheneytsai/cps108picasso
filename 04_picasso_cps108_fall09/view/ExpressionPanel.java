...
public class ExpressionPanel extends JPanel
{
    ...
    public void makePanel()
    {
        ...
        // Listener performs evaluate when the user presses "enter" in the text
        // field.
        ...
        this.setBorder(BorderFactory.createTitledBorder(myResources
                .getString("ExpressionTitle")));
    ...
    public void add(String name, final Command<Pixmap> action)
    {
        ...
        button.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                {
                    JOptionPane.showMessageDialog(myView, exception
