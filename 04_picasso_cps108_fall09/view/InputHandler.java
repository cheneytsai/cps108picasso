...
public abstract class InputHandler
{
    ...
    private static char historyToken = myResources.getString("HistoryToken")
            .charAt(0);
     ...
     * 
     * @param index
     *            of expression in expressionFavorites to be evaluated.
    ...
    public static boolean isFavoriteIndexValid(int index)
    {
        if (expressionFavorites.size() == 0 || index < 0
                || index > expressionFavorites.size() - 1)
            return false;
        return true;
    }
     ...
     * 
     * @param index
     *            of expression in expressionHistory to be evaluated.
